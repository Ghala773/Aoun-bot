...
async def chat(query_request: Query):
    ...
    # Friendly intro for event/museum queries
    elif any(word in user_query for word in ["event", "museum", "activity", "price", "location", "things to do", "places"]):
        response = f"Here's something exciting for you!\n\n{response}"
